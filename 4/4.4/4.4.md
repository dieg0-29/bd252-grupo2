...
| **estado_recepcion** | La situación actual de la recepción en el flujo logístico. | Indica el progreso de la recepción | Enumeración | ✅ | ❌ | ❌ | 'Programada', 'En Curso', 'Finalizada', 'Con Reclamo' |
...
| **estado_reclamo** | La situación actual del reclamo en el proceso de resolución. | Indica el progreso de la queja. | Enumeración | ✅ | ❌ | ❌ | 'Pendiente', 'En Gestión', 'Resuelto' |
| **observacion_reclamo** | Descripción detallada del problema o inconformidad. | Justifica el reclamo y adjunta evidencia (requerido por R-411). | Texto | ✅ | ❌ | ❌ | 'Llegaron 5 bolsas de cemento rotas.' |
| **accion_correctiva** | Solución acordada con el proveedor. | Trazar la resolución del reclamo (requerido por R-411). | Enumeración | ✅ | ❌ | ❌ | 'Nota de Crédito', 'Reemplazo de Producto', 'Otro' |
...
| **fecha_requerida** | La fecha límite o deseada en que el área solicitante necesita el producto. | Factor clave para determinar la urgencia (R-405). | Fecha | ✅ | ❌ | ❌ | '2025-11-15' |
...
| Atributo | Descripción | Propósito | Dominio de valores | Obligatoriedad | Unicidad | Multivaluado | Ejemplos |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **cantidad_comprada** | La cantidad del producto que se está comprando en esta OC. | Dato esencial para que Recepción (R-409) sepa cuánto programar. | Número entero | ✅ | ❌ | ❌ | 100 |
...
**Descripción:** Una recepción registra los productos que fueron recibidos y validados físicamente.<br>
**Propósito:** Registrar el conteo exacto de unidades conformes y defectuosas para la actualización de inventario.<br>
**Reglas de negocio relevantes:**
- Es una relación Muchos a Muchos (N:M).
...
| **cantidad_programada** | Unidades del producto que se esperan en una recepción específica. | Define la cantidad del "subgrupo" que el empleado creó al programar. | Número entero | ✅ | ❌ | ❌ | 50 |
