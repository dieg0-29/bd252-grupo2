...
| Atributo | Descripción | Propósito | Dominio de valores | Obligatoriedad | Unicidad | Multivaluado | Ejemplos |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **cod_producto** | Permite la identificación única e inequívoca de un producto. | Clave primaria para el modelado de relaciones e interacciones de manera robusta. | Texto | ✅ | ✅ | ❌ | 'P-001' |
...
| **cod_tipo** | Código de la categoría a la que pertenece el producto. | Identifica de forma única la clasificación del producto. | Texto| ✅ | ❌ | ❌ | 'HERR-01'|
...
| Atributo| Descripción| Propósito| Dominio de valores| Obligatoriedad| Unicidad| Multivaluado| Ejemplos|
|---------|------------|----------|-------------------|---------------|---------|-------------|---------|
|**cod_proveedor**| Permite la identificacion unica e inequivoca de un proveedor. | Permite el modelado de relaciones. |Texto| ✅ |✅| ❌ | prov-0001 |
