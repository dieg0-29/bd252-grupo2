...
|---------|------------|----------|-------------------|---------------|---------|-------------|---------|
|COD_PERSONA|Identificador único de la persona.|Sirve como clave primaria para esta entidad.|Texto (UUID)|✅|✅|❌| 123e4567-e89b-12d3-a456-426614174000 |
...
|NOMBRE|Nombre de la persona.|Identificador personal principal.|Texto|✅|❌|✅| Juan Garcia Perez |
...
| Atributo| Descripción| Propósito| Dominio de valores| Obligatoriedad| Unicidad| Multivaluado| Ejemplos|
|---------|------------|----------|-------------------|---------------|---------|-------------|---------|
|COD_CLIENTE|Identificador único del cliente.|Sirve como clave primaria para esta entidad.|Texto (UUID)|✅|✅|❌| 123e4567-e89b-12d3-a456-426614174000 |
...
|ULTIMA ACTIVIDAD CLIENTE|Conserva la fecha en la cual el cliente realizo su ultima accion|Proporciona informacion sobre la actividad del cliente.|Fecha y Hora|✅|❌|❌| 2025-09-22 10:30:00  |
...
| Atributo| Descripción| Propósito| Dominio de valores| Obligatoriedad| Unicidad| Multivaluado| Ejemplos|
|---------|------------|----------|-------------------|---------------|---------|-------------|---------|
|COD_MAESTRO|Identificador único del maestro.|Sirve como clave primaria para esta entidad.|Texto (UUID)|✅|✅|❌| 123e4567-e89b-12d3-a456-426614174000 |
...
|ULTIMA ACTIVIDAD MAESTRO|Conserva la fecha en la cual el maestro realizo su ultima accion|Proporciona informacion sobre la actividad del maestro.|Fecha y Hora|✅|❌|❌| 2025-09-22 10:30:00  |
...
| Atributo| Descripción| Propósito| Dominio de valores| Obligatoriedad| Unicidad| Multivaluado| Ejemplos|
|---------|------------|----------|-------------------|---------------|---------|-------------|---------|
|COD_USUARIO|Identificador único del usuario.|Sirve como clave primaria para esta entidad.|Texto (UUID)|✅|✅|❌| 123e4567-e89b-12d3-a456-426614174000 |
...
| Atributo| Descripción| Propósito| Dominio de valores| Obligatoriedad| Unicidad| Multivaluado| Ejemplos|
|---------|------------|----------|-------------------|---------------|---------|-------------|---------|
|COD_PREMIO| Permite la identificacion unica e inequivoca de un premio. | Permite el modelado de relaciones e interacciones de manera robusta. |Texto | ✅ |✅| ❌ | f81d4fae-7dec-11d0-a765-00a0c91e6bf7 |
...
|DISPONIBILIDAD|El estado de la existencia del premio.|Indica si el premio está disponible para canje en tiempo real.|Número entero|✅|❌|❌|      30 |
|COSTO DE PUNTOS|La cantidad de puntos necesaria para canjear el premio.|Define el valor del premio dentro del programa de fidelidad.|Número decimal|✅|❌|❌|150.00, 250.00|
...
| Atributo| Descripción| Propósito| Dominio de valores| Obligatoriedad| Unicidad| Multivaluado| Ejemplos|
|---------|------------|----------|-------------------|---------------|---------|-------------|---------|
|COD_CANJE| Permite la identificacion unica e inequivoca de un canjeo. | Permite el modelado de relaciones e interacciones de manera robusta. |Texto | ✅ |✅| ❌ | f81d4fae-7dec-11d0-a765-00a0c91e6bf9 |
...
### 🧾 Entidad: ` REPORTE CLIENTES `

**Descripción:** Representa una UN reporte generado para el modulo de clientes.<br>
**Propósito:** Permite al usuario visualizar metricas clave de comportamiento de clientes a lo largo de un periodo de tiempo.<br>
**Reglas de negocio relevantes:**
- El PERIODO_REPORTE debe ser un rango de tiempo, asegurando que las métricas se calculen para el período correcto.
- La FECHA_REPORTE debe ser la fecha en la que se genero el reporte.

| Atributo| Descripción| Propósito| Dominio de valores| Obligatoriedad| Unicidad| Multivaluado| Ejemplos|
|---------|------------|----------|-------------------|---------------|---------|-------------|---------|
|COD_REPORTE| Identificador único del reporte de clientes.	|Permite identificar de forma inequívoca cada instancia del reporte para su consulta y archivo.	|Cadena de texto alfanumérica, a menudo secuencial.	|✅|✅|❌|RC-202509-001, RC00458|
|PERIODO_REPORTE|El rango de tiempo que abarca los datos utilizados para calcular las métricas.	|Define el marco temporal para el análisis del comportamiento del cliente.	|Rango de Fechas (Formato: YYYY-MM-DD a YYYY-MM-DD), Mes/Año o Trimestre/Año.|✅|❌|❌| 2024-07-01 a 2024-09-30, AGOSTO 2025|
|FECHA_REPORTE|La fecha y hora exacta en la que se generó el reporte en el sistema.	 |Proporciona la marca de tiempo de la creación del documento para fines de auditoría y frescura de los datos.	|Fecha y hora|✅|❌|❌|2025-10-05 15:43:49|
