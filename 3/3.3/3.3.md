...
3.  El sistema muestra la lista de operadores y las solicitudes de preparación pendientes. Para añadir un operador: El usuario selecciona [Añadir Operador], completa el formulario y guarda. Para consultar/modificar, el usuario hace clic en un trabajador para ver o editar sus detalles.
![2](images/0102.png)

4. Para asignar una tarea: El usuario selecciona una solicitud (de picking o conteo), elige a uno o más operadores de la lista y confirma la asignación. 
![3](images/0103.png)
![3](images/0104.png)
---
