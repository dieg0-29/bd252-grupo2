...
2.  El sistema muestra la lista de operadores y las solicitudes de preparación pendientes.
   
3.  Para añadir un operador: El usuario selecciona [Añadir Operador], completa el formulario y guarda.
   
4.  Para consultar/modificar: El usuario hace clic en un trabajador para ver o editar sus detalles.
