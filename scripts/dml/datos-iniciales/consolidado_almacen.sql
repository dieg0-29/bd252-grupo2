...
INSERT INTO categoria_producto (rubro, familia, clase) VALUES
    ...
    ('Construcción', 'Materiales', 'Estructura'),      -- 2: Fierro, Maderas
    ('Construcción', 'Muros y Tabiques', 'Albañilería'), -- 3: Ladrillos
    ('Construcción', 'Muros y Tabiques', 'Ligeros'),   -- 4: Drywall, Perfiles
    ('Acabados', 'Revestimiento', 'Cerámico'),         -- 5: Cerámica, Pegamentos, Fragüe
    ('Acabados', 'Pintura', 'Exterior/Interior'),      -- 6: Látex, Esmalte, Sellador
    ('Acabados', 'Pintura', 'Solventes/Accesorios'),    -- 7: Thinner, Brochas, Rodillos
    ('Acabados', 'Adhesivos/Selladores', 'Químicos'),  -- 8: Silicona, Cintas
    ('Instalaciones', 'Eléctricas', 'Cableado'),       -- 9: Cables
    ('Instalaciones', 'Eléctricas', 'Dispositivos'),   -- 10: Tomas, Interruptores, Focos
    ('Instalaciones', 'Eléctricas', 'Seguridad'),      -- 11: Tableros Térmicos
    ('Instalaciones', 'Sanitarias/Plomería', 'Tuberías'), -- 12: Tubos PVC
    ('Instalaciones', 'Sanitarias/Plomería', 'Conexiones'), -- 13: Codos, Válvulas, Pegamentos PVC
    ('Herramientas', 'Eléctricas', 'Perforación/Corte'), -- 14: Taladros, Amoladoras
    ('Herramientas', 'Auxiliares', 'Elevación'),       -- 15: Escaleras
    ('Seguridad', 'Personal', 'Protección'),           -- 16: Guantes, Cascos, Lentes, Botas, Arnés
...
--TIPO_PERSONA
INSERT INTO TIPO_PERSONA (valor_tipo_persona)
VALUES 
('NATURAL'),
('JURÍDICA'),
('GUBERNAMENTAL');
SELECT * FROM TIPO_PERSONA TP ;
...
('Ana María Pérez Gómez',1),
('Juan Carlos López Ruiz',1),
('María Elena García Sánchez',1),
('Pedro Antonio Fernández Díaz',1),
('Laura Isabel Torres Romero',1),
('David Alejandro Cano Gil',1),
('Elena Cristina Vega Marín',1),
('Javier Núñez Bravo',1),
('Ricardo José Moya Polo',1),
('Sofía Alejandra Jiménez Cruz',1),
('Miguel Eduardo Ríos Vidal',1),
('Patricia Lucía Ruiz Mora',1),
('Andrés Gabriel Herrera Soto',1),
('Marta Irene Blázquez Prieto',1),
('José Luis Abad Soto',1),
('Carmen Rosa Vidal Sanz',1),
('Felipe Andrés Castro Pérez',1),
('Sara Valentina González Gil',1),
('Roberto Carlos Diez Cano',1),
('Natalia Victoria Vega Marín',1),
('Ricardo Moya Polo',1),
('Sofía Jiménez Cruz',1),
('Miguel Ángel Ríos Vidal',1),
('Patricia Ruiz Mora',1),
...
('Celia Torres Pérez',1),
('Iván Rivas Martín',1),
('María Fernanda Rojas Soto',1),
('Héctor Daniel Ramos Gil',1),
('Gabriela Torres Blanco',1),
('Ismael Soto Noguera',1),
('Valentina Diez Lara',1),
('Julián Pardo Montes',1),
('Andrea Cruz Vidal',1),
('Diego Alonso Marín Salas',1),
('Natalia Herrera Paz',1),
('Gonzalo Silva Moreno',1),
('Cecilia Rivas Soto',1),
('Luis Fernando Núñez Bravo',1),
('Diana Carolina López Gil',1),
('Eduardo José Vega Diez',1),
('Mónica Torres Sánchez',1),
('Raúl Pérez Rivas',1),
('Vanessa Gil Romero',1),
('Fernando Sánchez Diez',1),
('Eva María Núñez Soto',1),
('Javier Pardo Cruz',1),
('Paula Sanz López',1);
SELECT * FROM PERSONA;

--CLIENTE
INSERT INTO CLIENTE (cod_persona)
VALUES 
(1),
(2),
(3),
...
--TIPO_CONTACTO
INSERT INTO TIPO_CONTACTO (valor_tipo_contacto)
VALUES 
('CORREO'),
('TELEFONO CELULAR'),
('WHATSAPP');
...
--DIRECCION
INSERT INTO DIRECCION (ciudad, distrito, via, numero)
VALUES 
...
--TIPO_DOCUMENTO
INSERT INTO TIPO_DOCUMENTO (valor_tipo_documento)
VALUES 
('DNI'),
('CARNET EXTRANJERIA'),
('RUC');
...
--DOCUMENTO_PERSONA
INSERT INTO DOCUMENTO_PERSONA (valor_documento, cod_persona, cod_tipo_documento, principal_documento)
VALUES 
...
--DIRECCION_PERSONA
INSERT INTO DIRECCION_PERSONA (cod_direccion, cod_persona, principal_direccion)
VALUES 
(1,1,true),
(2,2,true),
(3,3,true),
...
--ESPECIALIDADES
INSERT INTO ESPECIALIDADES (valor_especialidad)
VALUES 
('Albañilería'), 
('Estructuras'), 
('Hormigón'), 
...
--MAESTRO
INSERT INTO MAESTRO (ruc, cod_cliente, cod_persona, cod_especialidad)
VALUES
('10456789012',6,14,4),
('10987654321',7,15,7),
('10112233445',8,16,9),
...
--USUARIO
INSERT INTO USUARIO (cod_persona, cod_rol, cod_area)
VALUES
(1,1,1),
(2,1,2),
(3,1,3),
...
INSERT INTO "FERRETERIA".vendedor (cod_usuario)
VALUES
  (1),
(2),
(3),
...
INSERT INTO producto (nombre_producto, unidad_medida, puntos_producto, precio_venta, cod_categoria_producto, marca, precio_base, peso_producto) VALUES
  ('Cemento Tipo I 42.5kg',        'saco',   80, 36.90, 1, 'Sol', 30.50, 42.500),
  ('Yeso construcción 25kg',       'saco',   45, 22.50, 17, 'Pered', 18.00, 25.000),
  ('Arena fina m3',                'm3',    120, 69.00, 1, 'Cantera', 55.00, 1500.000),
  ('Piedra chancada m3',           'm3',    120, 74.00, 1, 'Cantera', 60.00, 1200.000),
  ('Ladrillo King Kong',           'unidad',  1,  0.85, 3, 'P. del Norte', 0.55, 3.500),
  ('Ladrillo Pandereta',           'unidad',  1,  0.75, 3, 'P. del Norte', 0.45, 2.500),
  ('Fierro corrugado 1/2" x 9m',   'barra',  55, 63.00, 2, 'Arequipa', 50.00, 10.000),
  ('Fierro corrugado 3/8" x 9m',   'barra',  40, 39.50, 2, 'Arequipa', 32.00, 6.500),
  ('Clavos 2" 1kg',                'kg',     10,  8.90, 2, 'Nacional', 7.00, 1.000),
  ('Alambre recocido 1kg',         'kg',     10, 10.50, 2, 'Nacional', 8.50, 1.000),
  ('Madera tornillo 2x4x3m',       'pieza',  25, 39.90, 2, 'Perú', 30.00, 8.000),
  ('Plancha triplay 15mm',         'pieza',  40, 95.00, 2, 'Perú', 75.00, 15.000),
  ('Drywall placa 1.22x2.44m',     'pieza',  35, 48.00, 4, 'Gypsum', 38.00, 10.000),
  ('Perfil galvanizado T',         'pieza',  12, 14.90, 4, 'Metálicos', 10.00, 1.500),
  ('Pintura látex 1gal',           'galón',  40, 69.90, 6, 'American', 50.00, 5.000),
  ('Pintura esmalte 1gal',         'galón',  45, 79.90, 6, 'American', 60.00, 5.000),
  ('Sellador acrílico 1gal',       'galón',  30, 49.90, 6, 'Sika', 35.00, 5.000),
  ('Thinner 1gal',                 'galón',  20, 42.00, 7, 'Químico', 30.00, 4.000),
  ('Brocha 3"',                    'unidad',  6,  8.50, 7, 'Premium', 5.00, 0.100),
  ('Rodillo 9" con marco',         'unidad',  8, 14.90, 7, 'Premium', 10.00, 0.300),
  ('Silicona neutra 280ml',        'unidad',  6, 12.50, 8, 'Sika', 9.00, 0.350),
  ('Cinta masking 48mm x 40m',     'rollo',   4,  6.90, 8, '3M', 5.00, 0.150),
  ('Pega azulejo 25kg',            'saco',   35, 28.90, 5, 'Sika', 20.00, 25.000),
  ('Fragüe 5kg',                   'bolsa',   8, 13.90, 5, 'Sika', 10.00, 5.000),
  ('Cerámica piso 60x60 (caja)',   'caja',   90, 72.00, 5, 'Ital Gres', 55.00, 25.000),
  ('Pegamento PVC 118ml',          'unidad',  4,  9.90, 13, 'Oatey', 7.00, 0.150),
  ('Tubo PVC 1/2" x 3m',           'pieza',   6,  7.50, 12, 'Pavco', 5.00, 0.500),
  ('Codo PVC 1/2"',                'unidad',  2,  0.90, 13, 'Pavco', 0.50, 0.050),
  ('Válvula esfera 1/2"',          'unidad', 10, 12.90, 13, 'Kwik', 8.00, 0.200),
  ('Cable THW 12 AWG 100m',        'rollo', 120, 239.00, 9, 'Indeco', 180.00, 10.000),
  ('Cable THW 14 AWG 100m',        'rollo', 100, 199.00, 9, 'Indeco', 150.00, 8.000),
  ('Toma corriente simple',        'unidad',  6, 11.90, 10, 'Bticino', 8.00, 0.100),
  ('Interruptor simple',           'unidad',  6, 10.90, 10, 'Bticino', 7.50, 0.080),
  ('Foco LED 12W',                 'unidad',  4,  7.90, 10, 'Philips', 5.00, 0.050),
  ('Tablero térmico 2 polos',      'unidad', 30, 59.00, 11, 'Siemens', 45.00, 1.500),
  ('Taladro percutor 13mm',        'unidad',180, 269.00, 14, 'Dewalt', 180.00, 2.500),
  ('Amoladora 4-1/2"',             'unidad',160, 219.00, 14, 'Bosch', 150.00, 2.000),
  ('Escalera aluminio 6 peldaños', 'unidad',140, 319.00, 15, 'Forsa', 250.00, 12.000),
  ('Guantes de nitrilo',           'par',     3,  5.90, 16, 'MSA', 4.00, 0.050),
  ('Casco de seguridad',           'unidad', 12, 24.90, 16, 'MSA', 18.00, 0.400),
  ('Lentes de seguridad',          'unidad',  5,  9.50, 16, 'MSA', 6.00, 0.030),
  ('Botas punta acero',            'par',    40, 79.00, 16, 'Rhino', 60.00, 1.500),
  ('Arnés de seguridad',           'unidad', 60, 149.00, 16, 'Rhino', 120.00, 1.000),
  ('Sello de Goma para Tubería 4"', 'unidad', 5, 8.50, 13, 'Plast', 4.00, 0.100), -- ID 44
  ('Tornillo Autorroscante 1"', 'caja', 15, 29.90, 4, 'FixFast', 15.00, 0.500), -- ID 45
  ('Tijera para Drywall', 'unidad', 20, 45.00, 14, 'ToolsPro', 30.00, 0.400) -- ID 46
...
--CATEGORIA
INSERT INTO CATEGORIA (valor_categoria)
VALUES 
('Herramienta'), 
('Fijación'), 
('Adhesivo'), 
...
--ESTADO_CANJE
INSERT INTO ESTADO_CANJE (valor_estado_canje)
VALUES 
('Pendiente'), 
('Aprobado'), 
('En Preparación'), 
...
('Devuelto'), 
('Extraviado');
SELECT * FROM ESTADO_CANJE;

--CANJE
INSERT INTO CANJE (monto_canje, cod_usuario, cod_estado_canje, cod_maestro)
VALUES 
(30,9,1,6);
SELECT * FROM CANJE;

--PREMIOS
INSERT INTO PREMIOS (nombre_premio, descp_premio, puntos_premio, disponibilidad_premio)
VALUES 
...
--REPORTE
INSERT INTO REPORTE (periodo_reporte)
VALUES 
('1 YEAR');
SELECT * FROM REPORTE;
...
SELECT * FROM CLIENTE_CONSULTADO;
...
SELECT * FROM MAESTRO_CONSULTADO;



-- =========================================================
-- 4) NUEVAS TABLAS (MÓDULO ABASTECIMIENTO)
-- =========================================================

-- 1) INSTALACION (Almacenes/Sucursales)
INSERT INTO instalacion (cod_instalacion, nombre_instalacion, direccion) VALUES
('ALM01', 'Almacén Central Lima', 'Av. Separadora Industrial 500, Ate, Lima'),
('SUC02', 'Sucursal Norte Trujillo', 'Carretera Industrial Km 3.5, Moche, Trujillo'),
('ALM03', 'Almacén Sur Arequipa', 'Vía de Evitamiento Sur 1200, Cerro Colorado, Arequipa')
ON CONFLICT DO NOTHING;

-- 2) PROVEEDOR
INSERT INTO proveedor (nombre_comercial, razon_social, ruc) VALUES
('Cimientos Perú', 'Cimientos S.A.C.', '20123456781'),
('Tubos y Conexiones', 'Plásticos Andinos E.I.R.L.', '20876543212'),
('Herramientas Power', 'Comercial de Herramientas Power S.A.', '20555444333'),
('Seguridad Pro', 'Equipos de Protección y Seguridad Pro S.A.C.', '20111222333'),
('Pinturas Color', 'Distribuidora Nacional de Pinturas S.A.', '20666777888')
ON CONFLICT DO NOTHING;

-- 3) PRODUCTO_PROVEEDOR (Precios de referencia)
-- IDs de producto: 1=Cemento, 7=Fierro 1/2", 27=Tubo PVC, 36=Taladro, 15=Pintura Látex
INSERT INTO producto_proveedor (cod_producto, cod_proveedor, precio_unitario_ref) VALUES
(1, 1, 31.00), -- Cemento Tipo I 42.5kg (Base: 30.50)
(7, 1, 51.00), -- Fierro corrugado 1/2" x 9m (Base: 50.00)
(27, 2, 5.20), -- Tubo PVC 1/2" x 3m (Base: 5.00)
(36, 3, 190.00), -- Taladro percutor 13mm (Base: 180.00)
(15, 5, 52.00)  -- Pintura látex 1gal (Base: 50.00)
ON CONFLICT DO NOTHING;

-- 4) PROVEEDOR_CONTACTO
INSERT INTO proveedor_contacto (cod_proveedor, cod_tipo_contacto, valor_contacto) VALUES
(1, 1, 'ventas@cimientosperu.com'),
(1, 2, '900000001'),
(2, 1, 'logistica@tubosconexiones.pe'),
(3, 1, 'pedidos@hpower.com'),
(4, 2, '900000004'),
(5, 1, 'compras@pinturascolor.com')
ON CONFLICT DO NOTHING;

-- 5) SOLICITUD_COTIZACION (User 4: Gerente Abastecimiento)
INSERT INTO solicitud_cotizacion (cod_usuario, fecha_emision, estado) VALUES
(4, '2025-10-15', 'Adjudicada'), -- SC 1: Materiales de Construcción
(4, '2025-10-20', 'Cotizada')    -- SC 2: Herramientas
ON CONFLICT DO NOTHING;

-- 6) DETALLE_SOLICITUD
-- IDs de producto: 1=Cemento, 7=Fierro 1/2", 27=Tubo PVC, 36=Taladro, 37=Amoladora
INSERT INTO detalle_solicitud (cod_solicitud, cod_producto, cantidad_solicitada) VALUES
(1, 1, 100), -- Cemento
(1, 7, 50),  -- Fierro
(1, 27, 200), -- Tubo PVC
(2, 36, 10),  -- Taladro
...
-- 7) COTIZACION
INSERT INTO cotizacion (cod_solicitud, cod_proveedor, fecha_emision_cotizacion, fecha_garantia, monto_total, plazo_entrega) VALUES
(1, 1, '2025-10-16', '2025-11-16', 6690.00, 7), -- Cimientos Perú (Ganadora para SC 1)
(1, 2, '2025-10-17', '2025-11-17', 7000.00, 10), -- Tubos y Conexiones (Perdedora)
(2, 3, '2025-10-21', '2025-11-21', 3100.00, 5), -- Herramientas Power
(2, 4, '2025-10-22', '2025-11-22', 3900.00, 7)  -- Seguridad Pro
ON CONFLICT DO NOTHING;

-- 8) DETALLE_COTIZACION (Basado en SC 1 y Cot 1: Cimientos Perú)
INSERT INTO detalle_cotizacion (cod_cotizacion, cod_producto, costo_total, modalidad_pago) VALUES
(1, 1, 3100.00, 'Contado'), -- 100 * 31.00 (Prov 1)
(1, 7, 2550.00, 'Contado'), -- 50 * 51.00 (Prov 1)
(1, 27, 1040.00, 'Contado'),-- 200 * 5.20 (Prov 2, pero cotiza Prov 1)
-- Cotización 2 (Prov 2)
(2, 1, 3200.00, 'Crédito'),
(2, 7, 2600.00, 'Crédito'),
(2, 27, 1200.00, 'Crédito'),
-- Cotización 3 (Prov 3)
(3, 36, 1900.00, 'Crédito'), -- 10 * 190.00
(3, 37, 1200.00, 'Crédito') -- 8 * 150.00
ON CONFLICT DO NOTHING;

-- 9) ORDEN_COMPRA (Basada en Cotización 1, que fue 'Adjudicada')
INSERT INTO orden_compra (cod_cotizacion, fecha_emision, monto, modalidad_pago, estado) VALUES
(1, '2025-10-18', 6690.00, 'Contado', 'Programada') -- OC 1 (Adjudicada)
ON CONFLICT DO NOTHING;

-- 10) DETALLE_OC (Basado en OC 1)
INSERT INTO detalle_oc (cod_orden, cod_producto, cantidad_comprada, costo_total) VALUES
(1, 1, 100, 3100.00),
(1, 7, 50, 2550.00),
(1, 27, 200, 1040.00)
ON CONFLICT DO NOTHING;

-- 11) MONITOREO_COMPRA (Basado en OC 1)
INSERT INTO monitoreo_compra (cod_orden, fecha_entrega, hora_entrega, estado) VALUES
(1, '2025-10-25', '14:00:00', 'Entregado') -- Cot 1 tenía 7 días de plazo
ON CONFLICT DO NOTHING;

-- 12) PEDIDO_ABASTECIMIENTO (User 1: Almacén; User 5: Admin/Sistemas)
INSERT INTO pedido_abastecimiento (cod_usuario, fecha_pedido, hora_pedido, estado_pedido) VALUES
(1, '2025-11-01', '09:30:00', 'En Proceso'), -- Pedido 1 (Almacén)
(5, '2025-11-02', '11:00:00', 'Pendiente')  -- Pedido 2 (Sistemas)
ON CONFLICT DO NOTHING;

-- 13) DETALLE_PEDIDO
-- IDs: 13=Drywall, 14=Perfil T, 46=Tijera Drywall
INSERT INTO detalle_pedido (cod_pedido, cod_producto, cantidad_requerida, fecha_requerida, tipo_destino, direccion_destino_externo, estado) VALUES
(1, 13, 50, '2025-11-10', 'Interno', NULL, 'Adjudicado'),
(1, 14, 150, '2025-11-10', 'Interno', NULL, 'Adjudicado'),
(2, 46, 10, '2025-11-12', 'Externo', 'Av. Javier Prado 123, San Isidro', 'Pendiente')
ON CONFLICT DO NOTHING;

-- 14) RECEPCION (Basada en OC 1, Almacén ALM01, User 14: Almacenero)
INSERT INTO recepcion (cod_orden, cod_instalacion, fecha_recepcion, hora_inicio_recepcion, hora_fin_recepcion, fecha_programada, hora_programada, cod_usuario, observacion, estado_recepcion) VALUES
(1, 'ALM01', '2025-10-25', '14:05:00', '15:30:00', '2025-10-25', '14:00:00', 14, 'Recepción completa. 2 tubos PVC llegaron rajados.', 'Con Reclamo')
ON CONFLICT DO NOTHING;

-- 15) DETALLE_RECEPCION (Basado en Recepción 1 y OC 1)
INSERT INTO detalle_recepcion (cod_recepcion, cod_producto, cantidad_programada, cantidad_recibida, cantidad_conforme, cantidad_defectuosa) VALUES
(1, 1, 100, 100, 100, 0), -- Cemento
(1, 7, 50, 50, 50, 0),   -- Fierro
(1, 27, 200, 200, 198, 2)  -- Tubo PVC (2 defectuosos)
ON CONFLICT DO NOTHING;

-- 16) GUIA_REMISION_EXTERNA (Asociada a Recepción 1)
INSERT INTO guia_remision_externa (serie_correlativo, cod_recepcion, fecha_emision_guia, fecha_traslado_guia) VALUES
('T001-0012345', 1, '2025-10-24', '2025-10-25')
ON CONFLICT DO NOTHING;

-- 17) DETALLE_GUIA_EXTERNA (Basada en Guía T001-0012345)
INSERT INTO detalle_guia_externa (serie_correlativo, cod_producto, cantidad_guia) VALUES
('T001-0012345', 1, 100),
('T001-0012345', 7, 50),
('T001-0012345', 27, 200)
ON CONFLICT DO NOTHING;
...
-- 19) RECLAMO_ABAST (Reclamo por los 2 tubos PVC defectuosos de la Recepción 1)
INSERT INTO reclamo_abast (fecha_reclamo, hora_reclamo, observacion_reclamo, accion_correctiva, estado_reclamo) VALUES
('2025-10-26', '09:00:00', '2 Tubos PVC (Cod 27) llegaron rajados en Recepción 1 (OC 1)', 'Nota de Crédito', 'Resuelto')
ON CONFLICT DO NOTHING;

-- 20) NOTA_CREDITO_ABAST (Asociada al Reclamo 1)
-- Precio base Tubo PVC (ID 27) era 5.00. 2 * 5.20 (precio cotizado) = 10.40
INSERT INTO nota_credito_abast (cod_reclamo, fecha_nc, motivo_nc, monto_nc, descripcion_nc) VALUES
(1, '2025-10-28', 'Producto defectuoso', 10.40, 'NC por 2 unidades de Tubo PVC 1/2" (Cod 27) defectuosos.')
ON CONFLICT DO NOTHING;

-- 21) CAMBIO_PRODUCTO_ABAST (Simulación de otro reclamo)
INSERT INTO reclamo_abast (fecha_reclamo, hora_reclamo, observacion_reclamo, accion_correctiva, estado_reclamo) VALUES
('2025-10-27', '10:00:00', 'Se recibió Taladro (Cod 36) en lugar de Amoladora (Cod 37)', 'Reemplazo de Producto', 'En Gestión');

INSERT INTO cambio_producto_abast (cod_reclamo, fecha_cambio, hora_cambio, motivo_cambio, descripcion_cambio) VALUES
(2, '2025-10-29', '14:00:00', 'Error de picking proveedor', 'Proveedor recoge Taladro (Cod 36) y entrega Amoladora (Cod 37) pendiente.')
ON CONFLICT DO NOTHING;

-- 22) INCIDENCIA_ABAST (Asociada al Detalle de Recepción 1, producto 27)
...
-- =============================================================
-- INICIO: MÓDULO ALMACÉN (POBLACIÓN DE TABLAS MASIVA)
-- ESTE SCRIPT DEBE EJECUTARSE DESPUÉS DE 'datos_consolidado.sql'


RAISE NOTICE 'Iniciando Poblado Masivo de Módulo Almacén...';

-- 1. POBLAR LOOKUPS DE ALMACÉN (Instrucción 1)
RAISE NOTICE 'Paso 1: Poblando Lookups (Instalacion, Turno, Tipo Incidencia)...';
INSERT INTO "FERRETERIA".instalacion (cod_instalacion, nombre_instalacion, direccion) VALUES
('ALM-01', 'Almacén Central 1', 'Av. Argentina 1000, Callao'),
('ALM-02', 'Almacén Externo 2', 'Av. Gambetta 500, Callao'),
('TND-01', 'Tienda Principal', 'Av. La Marina 2040, San Miguel')
ON CONFLICT (cod_instalacion) DO NOTHING;

INSERT INTO "FERRETERIA".turno_almacen (cod_turno, hora_inicio, hora_fin) VALUES
('T-0800', '08:00:00', '09:00:00'),
('T-0900', '09:00:00', '10:00:00'),
('T-1000', '10:00:00', '11:00:00'),
('T-1100', '11:00:00', '12:00:00'),
('T-1200', '12:00:00', '13:00:00'),
('T-1300', '13:00:00', '14:00:00'),
('T-1400', '14:00:00', '15:00:00'),
('T-1500', '15:00:00', '16:00:00'),
('T-1600', '16:00:00', '17:00:00'),
('T-1700', '17:00:00', '18:00:00')
ON CONFLICT (cod_turno) DO NOTHING;

INSERT INTO "FERRETERIA".tipo_incidencia_lookup (descripcion) VALUES
('Faltante'),
('Sobrante'),
('Producto Incorrecto'),
('Roto / Dañado'),
...
-- 2. CREAR ESTRUCTURA DE UBICACIONES (Jerarquía) (Instrucción 2)
RAISE NOTICE 'Paso 2: Creando Estructura de Ubicaciones (Jerarquía)...';
-- Ubicaciones RAÍZ de Merma
INSERT INTO "FERRETERIA".ubicacion (cod_ubicacion, cod_instalacion, cod_ubicacion_padre, tipo_ubicacion, nombre_logico, cod_ubicacion_calculado) VALUES
('UB-ALM1-MERMA', 'ALM-01', NULL, 'MERMA', 'MERMA-ALM1', 'ALM01-MERMA'),
('UB-ALM2-MERMA', 'ALM-02', NULL, 'MERMA', 'MERMA-ALM2', 'ALM02-MERMA'),
('UB-TND1-MERMA', 'TND-01', NULL, 'MERMA', 'MERMA-TND1', 'TND01-MERMA')
ON CONFLICT (cod_ubicacion) DO NOTHING;

-- Jerarquía Almacén 1 (2 niveles)
INSERT INTO "FERRETERIA".ubicacion (cod_ubicacion, cod_instalacion, cod_ubicacion_padre, tipo_ubicacion, nombre_logico, cod_ubicacion_calculado) VALUES
('UB-ALM1-Z-A', 'ALM-01', NULL, 'ZONA', 'Z-A', 'ALM01-Z-A'),
('UB-ALM1-Z-A-E01', 'ALM-01', 'UB-ALM1-Z-A', 'ESPACIO', 'E01', 'ALM01-Z-A-E01') -- Ubicación de VENTA principal ALM-01
ON CONFLICT (cod_ubicacion) DO NOTHING;

-- Jerarquía Almacén 2 (similar a ALM-01)
INSERT INTO "FERRETERIA".ubicacion (cod_ubicacion, cod_instalacion, cod_ubicacion_padre, tipo_ubicacion, nombre_logico, cod_ubicacion_calculado) VALUES
('UB-ALM2-Z-A', 'ALM-02', NULL, 'ZONA', 'Z-A', 'ALM02-Z-A'),
('UB-ALM2-Z-A-E01', 'ALM-02', 'UB-ALM2-Z-A', 'ESPACIO', 'E01', 'ALM02-Z-A-E01') -- Ubicación de VENTA principal ALM-02
ON CONFLICT (cod_ubicacion) DO NOTHING;

-- Jerarquía Tienda 1 (4 niveles)
INSERT INTO "FERRETERIA".ubicacion (cod_ubicacion, cod_instalacion, cod_ubicacion_padre, tipo_ubicacion, nombre_logico, cod_ubicacion_calculado) VALUES
('UB-TND1-P01', 'TND-01', NULL, 'PASILLO', 'P01', 'TND01-P01'),
('UB-TND1-P01-E03', 'TND-01', 'UB-TND1-P01', 'ESTANTE', 'E03', 'TND01-P01-E03'),
('UB-TND1-P01-E03-N02', 'TND-01', 'UB-TND1-P01-E03', 'NIVEL', 'N02', 'TND01-P01-E03-N02'),
('UB-TND1-P01-E03-N02-C04', 'TND-01', 'UB-TND1-P01-E03-N02', 'CASILLA', 'C04', 'TND01-P01-E03-N02-C04') -- VENTA Casilla
ON CONFLICT (cod_ubicacion) DO NOTHING;

-- "Problema del Lavadero" (Estante hijo de Pasillo)
INSERT INTO "FERRETERIA".ubicacion (cod_ubicacion, cod_instalacion, cod_ubicacion_padre, tipo_ubicacion, nombre_logico, cod_ubicacion_calculado) VALUES
('UB-TND1-P01-E04', 'TND-01', 'UB-TND1-P01', 'ESTANTE', 'E04', 'TND01-P01-E04') -- VENTA Estante
ON CONFLICT (cod_ubicacion) DO NOTHING;

-- 3. DEFINIR CAPACIDAD DE TURNOS (Plantilla R-307) (Instrucción 3)
RAISE NOTICE 'Paso 3: Expandiendo Plantilla de Capacidad de Turnos...';
INSERT INTO "FERRETERIA".capacidad_turno (cod_instalacion, cod_turno, dia_semana, capacidad_total)
SELECT
    i.cod_instalacion,
    t.cod_turno,
    d.dia_semana,
    -- Capacidad: ALM-01 (5), ALM-02 (3), TND-01 (2). Fines de semana (dia 6,7) tienen menos.
    CASE
        WHEN d.dia_semana IN (6, 7) THEN 2 -- Capacidad reducida Sábado/Domingo
        WHEN i.cod_instalacion = 'ALM-01' THEN 5
        WHEN i.cod_instalacion = 'ALM-02' THEN 3
        WHEN i.cod_instalacion = 'TND-01' THEN 2
        ELSE 1
    END AS capacidad_total
FROM "FERRETERIA".instalacion i
CROSS JOIN "FERRETERIA".turno_almacen t
CROSS JOIN generate_series(1, 7) AS d(dia_semana)
ON CONFLICT (cod_instalacion, cod_turno, dia_semana) DO NOTHING;

-- 4. CREAR INVENTARIO INICIAL (STOCK CERO) (Instrucción 4)
RAISE NOTICE 'Paso 4: Creando esqueleto de Inventario (Stock 0)...';
-- Se asume Producto 45 = 'Tornillo Autorroscante 1"'
-- Se asume Producto 44 = 'Sello de Goma para Tubería 4"' (Simulando Lavadero)
INSERT INTO "FERRETERIA".inventario (stock_fisico, stock_comprometido, stock_minimo, stock_maximo, cod_producto, cod_ubicacion) VALUES
-- Regla de Oro (Venta)
(0, 0, 50, 200, 45, 'UB-TND1-P01-E03-N02-C04'), -- Tornillo en Casilla
(0, 0, 5, 20, 44, 'UB-TND1-P01-E04'),           -- "Lavadero" en Estante
-- Excepción (Merma)
(0, 0, 0, 0, 45, 'UB-TND1-MERMA')               -- Tornillo en Merma
ON CONFLICT (cod_producto, cod_ubicacion) DO NOTHING;

-- Poblar el resto de productos en la ubicación principal de ALM-01
INSERT INTO "FERRETERIA".inventario (stock_fisico, stock_comprometido, stock_minimo, stock_maximo, cod_producto, cod_ubicacion)
SELECT 0, 0, 20, 100, p.cod_producto, 'UB-ALM1-Z-A-E01'
FROM "FERRETERIA".producto p
WHERE p.cod_producto NOT IN (44, 45)
ON CONFLICT (cod_producto, cod_ubicacion) DO NOTHING;

-- Poblar el resto de productos en la ubicación de MERMA de ALM-01
INSERT INTO "FERRETERIA".inventario (stock_fisico, stock_comprometido, stock_minimo, stock_maximo, cod_producto, cod_ubicacion)
SELECT 0, 0, 0, 0, p.cod_producto, 'UB-ALM1-MERMA'
FROM "FERRETERIA".producto p
WHERE p.cod_producto NOT IN (44, 45)
ON CONFLICT (cod_producto, cod_ubicacion) DO NOTHING;

-- 5. POBLAR "TICKETS" (cupo_disponible) (Instrucción 5)
RAISE NOTICE 'Paso 5: Generando Cupos Disponibles para 90 días...';
-- Se llama a la función (creada en 10.4) para poblar 30 días pasados y 60 futuros.
SELECT "FERRETERIA".sp_generar_cupos_almacen(NOW()::DATE - '30 days'::interval, 90);

-- 6. TAREAS DE CONTEO (Instrucción 6)
RAISE NOTICE 'Paso 6: Creando 20 Tareas de Conteo Cíclico...';
INSERT INTO "FERRETERIA".conteo (cod_conteo, fecha_conteo, hora_conteo, estado)
SELECT
    'CON-' || lpad(g.n::text, 3, '0'),
    NOW()::DATE - (g.n % 10 || ' days')::interval, -- Fechas en los últimos 10 días
    (SELECT hora_inicio FROM turno_almacen ORDER BY random() LIMIT 1),
    CASE WHEN g.n % 3 = 0 THEN 'Completado' ELSE 'En Proceso' END
FROM generate_series(1, 20) g(n)
ON CONFLICT (cod_conteo) DO NOTHING;

-- 7. CREAR RESERVAS DE ALMACÉN (Instrucción 7)
RAISE NOTICE 'Paso 7: Vinculando Reservas a Recepciones (1) y Despachos (22)...';
-- Se vinculan TODAS las recepciones y despachos existentes a un cupo disponible.
-- Primero, Recepciones (1)
WITH recepcion_data AS (
    SELECT
        rec.cod_recepcion,
        rec.fecha_programada,
        rec.hora_programada,
        rec.cod_instalacion,
        (SELECT cod_turno FROM turno_almacen t WHERE rec.hora_programada BETWEEN t.hora_inicio AND t.hora_fin LIMIT 1) AS cod_turno
    FROM "FERRETERIA".recepcion rec
    LEFT JOIN "FERRETERIA".reserva_almacen ra ON rec.cod_recepcion = ra.cod_recepcion
    WHERE ra.cod_reserva IS NULL -- Solo las que no tengan reserva
),
cupo_asignado_rec AS (
    SELECT
        rd.cod_recepcion,
        (SELECT c.cod_cupo
         FROM "FERRETERIA".cupo_disponible c
         WHERE c.estado = 'Disponible'
           AND c.fecha_cupo = rd.fecha_programada
           AND c.cod_turno = rd.cod_turno
           AND c.cod_instalacion = rd.cod_instalacion
         ORDER BY c.cod_cupo
         LIMIT 1) AS cod_cupo
    FROM recepcion_data rd
)
INSERT INTO "FERRETERIA".reserva_almacen (cod_reserva, tipo_reserva, estado, cod_recepcion, cod_despacho, cod_cupo)
SELECT
    'R-' || lpad(ca.cod_recepcion::text, 3, '0'),
    'Recepcion',
    'Confirmado',
    ca.cod_recepcion,
    NULL,
    ca.cod_cupo
FROM cupo_asignado_rec ca WHERE ca.cod_cupo IS NOT NULL
ON CONFLICT (cod_reserva) DO NOTHING;

-- Segundo, Despachos (22)
WITH despacho_data AS (
    SELECT
        d.cod_despacho,
        d.fecha_despacho,
        d.hora_salida_estimada,
        -- Asumimos que el picking se hace en ALM-01 (requiere lógica más compleja para saber origen)
        'ALM-01' AS cod_instalacion,
        (SELECT cod_turno FROM turno_almacen t WHERE d.hora_salida_estimada BETWEEN t.hora_inicio AND t.hora_fin LIMIT 1) AS cod_turno
    FROM "FERRETERIA".despacho d
    LEFT JOIN "FERRETERIA".reserva_almacen ra ON d.cod_despacho = ra.cod_despacho
    WHERE ra.cod_reserva IS NULL -- Solo los que no tengan reserva
),
cupo_asignado_des AS (
    SELECT
        dd.cod_despacho,
        (SELECT c.cod_cupo
         FROM "FERRETERIA".cupo_disponible c
         WHERE c.estado = 'Disponible'
           AND c.fecha_cupo = dd.fecha_despacho
           -- AND c.cod_turno = dd.cod_turno  -- Comentado porque los turnos pueden no coincidir
           AND c.cod_instalacion = dd.cod_instalacion
         ORDER BY c.cod_cupo
         LIMIT 1) AS cod_cupo
    FROM despacho_data dd
)
INSERT INTO "FERRETERIA".reserva_almacen (cod_reserva, tipo_reserva, estado, cod_recepcion, cod_despacho, cod_cupo)
SELECT
    'T-' || lpad(ca.cod_despacho::text, 3, '0'),
    'Despacho',
    'Confirmado',
    NULL,
    ca.cod_despacho,
    ca.cod_cupo
FROM cupo_asignado_des ca WHERE ca.cod_cupo IS NOT NULL
ON CONFLICT (cod_reserva) DO NOTHING;

-- Marcar todos los cupos usados como 'Reservado' (Instrucción 5)
UPDATE "FERRETERIA".cupo_disponible
SET estado = 'Reservado'
WHERE cod_cupo IN (SELECT cod_cupo FROM "FERRETERIA".reserva_almacen);

-- 8. DETALLES DE CONTEO (Instrucción 8)
RAISE NOTICE 'Paso 8: Creando Detalles para las 20 tareas de conteo...';
INSERT INTO "FERRETERIA".detalle_conteo (cantidad_sistema, cantidad_contada, discrepancia, cod_conteo, cod_producto)
SELECT
    100 AS cantidad_sistema, -- Stock de "pantallazo" (simulado)
    CASE 
        WHEN c.cod_conteo = 'CON-001' AND p.cod_producto = 7 THEN 98 -- Forzar discrepancia -2 (Instrucción 10)
        WHEN g.n % 5 = 0 THEN 100 -- 1 de cada 5 OK
        ELSE 100 - (g.n % 3) -- Discrepancias pequeñas (0, -1, -2)
    END AS cantidad_contada,
    CASE 
        WHEN c.cod_conteo = 'CON-001' AND p.cod_producto = 7 THEN -2
        WHEN g.n % 5 = 0 THEN 0
        ELSE -(g.n % 3)
    END AS discrepancia,
    c.cod_conteo,
...
CROSS JOIN generate_series(1, 3) g(n) -- 3 productos por tarea de conteo
JOIN "FERRETERIA".producto p ON p.cod_producto = (g.n + (c.cod_conteo::int % 10)) -- Seleccionar productos variados
ON CONFLICT (cod_detalle_conteo) DO NOTHING;

-- 9. ASIGNACIÓN DE OPERADORES (Instrucción 9)
RAISE NOTICE 'Paso 9: Asignando Operadores a todas las Tareas...';
-- Asignar usuarios 14 y 1 a todas las reservas
INSERT INTO "FERRETERIA".operador_reserva_almacen (cod_usuario, cod_reserva)
SELECT u.cod_usuario, r.cod_reserva
FROM "FERRETERIA".usuario u
CROSS JOIN "FERRETERIA".reserva_almacen r
WHERE u.cod_usuario IN (1, 14) -- David Ricardo y Pedro Carlos
ON CONFLICT (cod_usuario, cod_reserva) DO NOTHING;

-- Asignar usuarios 14 y 1 a todos los conteos
INSERT INTO "FERRETERIA".operador_conteo (cod_usuario, cod_conteo)
SELECT u.cod_usuario, c.cod_conteo
FROM "FERRETERIA".usuario u
CROSS JOIN "FERRETERIA".conteo c
WHERE u.cod_usuario IN (1, 14)
ON CONFLICT (cod_usuario, cod_conteo) DO NOTHING;

-- 10. TABLA DE INCIDENCIA (Instrucción 10)
RAISE NOTICE 'Paso 10: Creando Incidencias de Recepción y Conteo...';
-- A. Incidencia de Recepción (del detalle_recepcion ID 3)
INSERT INTO "FERRETERIA".incidencia (cod_incidencia, cod_tipo_incidencia, cantidad_afectada, accion_tomada, descripcion, cod_detalle_recepcion, cod_detalle_conteo)
SELECT
    'INC-REC-001',
    (SELECT cod_tipo_incidencia FROM tipo_incidencia_lookup WHERE descripcion = 'Roto / Dañado'),
    dr.cantidad_defectuosa,
    'Aceptar', -- accion_tomada REQUERIDA para recepción
    'Incidencia de recepción: ' || dr.cantidad_defectuosa || ' unidades rotas.',
    dr.cod_detalle_recepcion,
    NULL
FROM "FERRETERIA".detalle_recepcion dr
WHERE dr.cantidad_defectuosa > 0
ON CONFLICT (cod_incidencia) DO NOTHING;

-- B. Incidencias de Conteo (de todos los detalle_conteo con discrepancia)
INSERT INTO "FERRETERIA".incidencia (cod_incidencia, cod_tipo_incidencia, cantidad_afectada, accion_tomada, descripcion, cod_detalle_recepcion, cod_detalle_conteo)
SELECT
    'INC-CON-' || lpad(dc.cod_detalle_conteo::text, 3, '0'),
    -- Si la discrepancia es -1, la marcamos como "Roto", si es > -1, como "Faltante"
    (SELECT cod_tipo_incidencia FROM tipo_incidencia_lookup WHERE descripcion = CASE WHEN dc.discrepancia = -1 THEN 'Roto / Dañado' ELSE 'Faltante' END),
    ABS(dc.discrepancia),
    NULL, -- accion_tomada es NULL para conteo
    'Incidencia de conteo: Discrepancia de ' || dc.discrepancia,
    NULL,
    dc.cod_detalle_conteo
FROM "FERRETERIA".detalle_conteo dc
WHERE dc.discrepancia <> 0
ON CONFLICT (cod_incidencia) DO NOTHING;


-- 11. TABLA DE MOVIMIENTO (KARDEX) Y ACTUALIZACIÓN DE STOCK (Instrucción 11)
RAISE NOTICE 'Paso 11: Generando Kardex (Movimientos) y Actualizando Stock...';

-- A. MOVIMIENTOS POR RECEPCIÓN (BUENO)
INSERT INTO "FERRETERIA".movimiento (tipo_movimiento, cantidad, cod_inventario, cod_detalle_recepcion)
SELECT
    'ENTRADA' AS tipo_movimiento,
    dr.cantidad_conforme AS cantidad,
    i.cod_inventario,
    dr.cod_detalle_recepcion
FROM "FERRETERIA".detalle_recepcion dr
JOIN "FERRETERIA".recepcion r ON dr.cod_recepcion = r.cod_recepcion
JOIN "FERRETERIA".ubicacion u ON r.cod_instalacion = u.cod_instalacion
JOIN "FERRETERIA".inventario i ON u.cod_ubicacion = i.cod_ubicacion AND dr.cod_producto = i.cod_producto
WHERE dr.cantidad_conforme > 0 AND u.tipo_ubicacion <> 'MERMA'; -- Asume que el bueno va a VENTA

-- B. MOVIMIENTOS POR RECEPCIÓN (MALO/MERMA)
INSERT INTO "FERRETERIA".movimiento (tipo_movimiento, cantidad, cod_inventario, cod_detalle_recepcion, cod_incidencia)
SELECT
    'MERMA_ENTRADA' AS tipo_movimiento,
    inc.cantidad_afectada AS cantidad,
    i.cod_inventario,
    inc.cod_detalle_recepcion,
    inc.cod_incidencia
FROM "FERRETERIA".incidencia inc
JOIN "FERRETERIA".detalle_recepcion dr ON inc.cod_detalle_recepcion = dr.cod_detalle_recepcion
JOIN "FERRETERIA".recepcion r ON dr.cod_recepcion = r.cod_recepcion
JOIN "FERRETERIA".ubicacion u ON r.cod_instalacion = u.cod_instalacion
JOIN "FERRETERIA".inventario i ON u.cod_ubicacion = i.cod_ubicacion AND dr.cod_producto = i.cod_producto
WHERE inc.cod_detalle_recepcion IS NOT NULL AND inc.accion_tomada = 'Aceptar' AND u.tipo_ubicacion = 'MERMA'; -- Malo va a MERMA

-- C. MOVIMIENTOS POR VENTA (SALIDA) (El más grande)
INSERT INTO "FERRETERIA".movimiento (tipo_movimiento, cantidad, cod_inventario, cod_venta, cod_producto_vta)
SELECT
    'SALIDA' AS tipo_movimiento,
    pv.cantidad_producto AS cantidad,
    i.cod_inventario,
    pv.cod_venta,
    pv.cod_producto
FROM "FERRETERIA".producto_venta pv
JOIN "FERRETERIA".venta v ON pv.cod_venta = v.cod_venta
JOIN "FERRETERIA".estado_venta ev ON v.cod_estado_venta = ev.cod_estado_venta
-- Asume que el stock de VENTA está en 'UB-ALM1-Z-A-E01' para la mayoría, y 'UB-TND1-...' para 44 y 45
JOIN "FERRETERIA".inventario i ON pv.cod_producto = i.cod_producto
WHERE
    ev.descp_estado_venta <> 'Anulada' -- Solo ventas válidas
    AND (
        (pv.cod_producto = 45 AND i.cod_ubicacion = 'UB-TND1-P01-E03-N02-C04') OR
        (pv.cod_producto = 44 AND i.cod_ubicacion = 'UB-TND1-P01-E04') OR
        (pv.cod_producto NOT IN (44, 45) AND i.cod_ubicacion = 'UB-ALM1-Z-A-E01')
    );

-- D. MOVIMIENTOS POR CONTEO (AJUSTES Y MERMAS)
-- D1. Ajuste Negativo (Faltante)
INSERT INTO "FERRETERIA".movimiento (tipo_movimiento, cantidad, cod_inventario, cod_detalle_conteo, cod_incidencia)
SELECT
    'AJUSTE_NEGATIVO' AS tipo_movimiento,
    inc.cantidad_afectada AS cantidad,
    i.cod_inventario,
    inc.cod_detalle_conteo,
    inc.cod_incidencia
FROM "FERRETERIA".incidencia inc
JOIN "FERRETERIA".tipo_incidencia_lookup til ON inc.cod_tipo_incidencia = til.cod_tipo_incidencia
JOIN "FERRETERIA".detalle_conteo dc ON inc.cod_detalle_conteo = dc.cod_detalle_conteo
JOIN "FERRETERIA".inventario i ON dc.cod_producto = i.cod_producto
WHERE inc.cod_detalle_conteo IS NOT NULL AND til.descripcion = 'Faltante'
  AND (
        (dc.cod_producto = 45 AND i.cod_ubicacion = 'UB-TND1-P01-E03-N02-C04') OR
        (dc.cod_producto = 44 AND i.cod_ubicacion = 'UB-TND1-P01-E04') OR
        (dc.cod_producto NOT IN (44, 45) AND i.cod_ubicacion = 'UB-ALM1-Z-A-E01')
    );

-- D2. Merma Salida (de Venta) y Entrada (a Merma)
DO $$
DECLARE
    r RECORD;
    v_inv_venta INT;
...
BEGIN
    FOR r IN
        SELECT inc.cantidad_afectada, inc.cod_detalle_conteo, inc.cod_incidencia, dc.cod_producto
        FROM "FERRETERIA".incidencia inc
        JOIN "FERRETERIA".tipo_incidencia_lookup til ON inc.cod_tipo_incidencia = til.cod_tipo_incidencia
        JOIN "FERRETERIA".detalle_conteo dc ON inc.cod_detalle_conteo = dc.cod_detalle_conteo
        WHERE inc.cod_detalle_conteo IS NOT NULL AND til.descripcion IN ('Roto / Dañado', 'Húmedo', 'Oxidado', 'Vencido', 'Empaque Dañado')
    LOOP
        -- Encontrar inventario de VENTA
        SELECT i.cod_inventario INTO v_inv_venta
        FROM "FERRETERIA".inventario i
        WHERE i.cod_producto = r.cod_producto
          AND (
            (r.cod_producto = 45 AND i.cod_ubicacion = 'UB-TND1-P01-E03-N02-C04') OR
            (r.cod_producto = 44 AND i.cod_ubicacion = 'UB-TND1-P01-E04') OR
            (r.cod_producto NOT IN (44, 45) AND i.cod_ubicacion = 'UB-ALM1-Z-A-E01')
          );
          
        -- Encontrar inventario de MERMA
        SELECT i.cod_inventario INTO v_inv_merma
        FROM "FERRETERIA".inventario i
        JOIN "FERRETERIA".ubicacion u ON i.cod_ubicacion = u.cod_ubicacion
        WHERE i.cod_producto = r.cod_producto AND u.tipo_ubicacion = 'MERMA'
        LIMIT 1; -- Asume una ubicación de merma por producto

        -- 1. Movimiento MERMA_SALIDA (Sale de VENTA)
        INSERT INTO "FERRETERIA".movimiento (tipo_movimiento, cantidad, cod_inventario, cod_detalle_conteo, cod_incidencia)
        VALUES ('MERMA_SALIDA', r.cantidad_afectada, v_inv_venta, r.cod_detalle_conteo, r.cod_incidencia);

        -- 2. Movimiento MERMA_ENTRADA (Entra a MERMA)
        INSERT INTO "FERRETERIA".movimiento (tipo_movimiento, cantidad, cod_inventario, cod_detalle_conteo, cod_incidencia)
        VALUES ('MERMA_ENTRADA', r.cantidad_afectada, v_inv_merma, r.cod_detalle_conteo, r.cod_incidencia);
    END LOOP;
END $$;


-- E. ACTUALIZACIÓN FINAL DE STOCK (El Gran Total)
RAISE NOTICE 'Paso 11e: Calculando Stock Físico y Comprometido final...';

-- 1. Actualizar STOCK FÍSICO basado en TODOS los movimientos
WITH StockCalculado AS (
    SELECT
        cod_inventario,
        SUM(CASE 
                WHEN tipo_movimiento IN ('ENTRADA', 'MERMA_ENTRADA', 'AJUSTE_POSITIVO') THEN cantidad
                WHEN tipo_movimiento IN ('SALIDA', 'MERMA_SALIDA', 'AJUSTE_NEGATIVO') THEN -cantidad
                ELSE 0
            END) AS stock_final
    FROM "FERRETERIA".movimiento
    GROUP BY cod_inventario
)
UPDATE "FERRETERIA".inventario i
SET stock_fisico = sc.stock_final
FROM StockCalculado sc
WHERE i.cod_inventario = sc.cod_inventario;

-- 2. Actualizar STOCK COMPROMETIDO basado en ventas 'Por pagar'
WITH StockComprometido AS (
    SELECT
        i.cod_inventario,
        SUM(pv.cantidad_producto) AS total_comprometido
    FROM "FERRETERIA".producto_venta pv
    JOIN "FERRETERIA".venta v ON pv.cod_venta = v.cod_venta
    JOIN "FERRETERIA".estado_venta ev ON v.cod_estado_venta = ev.cod_estado_venta
    -- Se une con inventario para saber QUÉ inventario comprometer
    JOIN "FERRETERIA".inventario i ON pv.cod_producto = i.cod_producto
    WHERE ev.descp_estado_venta = 'Por pagar'
      AND (
            (pv.cod_producto = 45 AND i.cod_ubicacion = 'UB-TND1-P01-E03-N02-C04') OR
            (pv.cod_producto = 44 AND i.cod_ubicacion = 'UB-TND1-P01-E04') OR
            (pv.cod_producto NOT IN (44, 45) AND i.cod_ubicacion = 'UB-ALM1-Z-A-E01')
        )
    GROUP BY i.cod_inventario
)
UPDATE "FERRETERIA".inventario i
SET stock_comprometido = sc.total_comprometido
FROM StockComprometido sc
WHERE i.cod_inventario = sc.cod_inventario;

RAISE NOTICE 'Poblado Masivo de Módulo Almacén COMPLETADO.';
